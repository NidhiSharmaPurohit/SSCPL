...
{
    public partial class CashMemoDisplayAndPrint : Form
    {
        ...
        public CashMemoDisplayAndPrint()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            PdfWriter.GetInstance(doc, new FileStream("Cash Memo " + _Invoices[0].InvoiceNum + ".pdf", FileMode.Create, FileAccess.ReadWrite));
            doc.Open();

           

            Paragraph p = new Paragraph("Cash Memo", new iTextSharp.text.Font(iTextSharp.text.Font.FontFamily.COURIER, iTextSharp.text.Font.BOLD, iTextSharp.text.Font.BOLD, BaseColor.CYAN));
            doc.Add(p);

            Paragraph p1 = new Paragraph("Cash Memo Number : " + _Invoices[0].InvoiceNum, new iTextSharp.text.Font(iTextSharp.text.Font.FontFamily.COURIER, iTextSharp.text.Font.DEFAULTSIZE, iTextSharp.text.Font.NORMAL));
            doc.Add(p1);
            ...
            Paragraph p3 = new Paragraph("Cash Memo Date : " + _Invoices[0].InvoiceDate.ToString(), new iTextSharp.text.Font(iTextSharp.text.Font.FontFamily.COURIER, iTextSharp.text.Font.DEFAULTSIZE, iTextSharp.text.Font.NORMAL, BaseColor.BLUE));
            doc.Add(p3);

            Paragraph p4 = new Paragraph(string.Format("Cash Memo Duration : {0} to {1}", _Invoices[0].FromDate.ToString(), _Invoices[0].ToDate.ToString()), new iTextSharp.text.Font(iTextSharp.text.Font.FontFamily.COURIER, iTextSharp.text.Font.DEFAULTSIZE, iTextSharp.text.Font.NORMAL, BaseColor.BLUE));
            doc.Add(p4);

            PdfPTable table = new PdfPTable(8);
            PdfPCell cell = new PdfPCell(new Paragraph("Items Detail", new iTextSharp.text.Font(iTextSharp.text.Font.FontFamily.COURIER, 12, iTextSharp.text.Font.NORMAL, BaseColor.BLUE)));
            cell.Colspan = 8;
            table.AddCell(cell);
            ...
            try
            {
                System.Diagnostics.Process.Start("Cash Memo " + _Invoices[0].InvoiceNum + ".pdf");
            }
            catch (Exception exp)
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string pdfname = "Cash Memo " + _Invoices[0].InvoiceNum + ".pdf";
        ...
        private void CashMemoDisplayAndPrint_Load(object sender, EventArgs e)
        {
