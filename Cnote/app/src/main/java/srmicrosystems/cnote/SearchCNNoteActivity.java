...
public class SearchCNNoteActivity extends Activity implements View.OnClickListener {
Context ctx;
...
private ImageButton barcode ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_cnnote);
        ctx = this;
       ...
       // barcodeValue = (TextView)findViewById(R.id.barcode_value);
        ...
        btnSearchCNNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in=new Intent(ctx ,srmicrosystems.cnote.CNNoteExtDetailsActivity.class);
