...
public class CnnotePaymentSearch extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cnnote_payment_search);
        ...
        btnSearchCNNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in=new Intent(ctx ,srmicrosystems.cnote.CnnotePayment.class);
